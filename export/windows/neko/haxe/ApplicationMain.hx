...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "GameOff", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "GameOff";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "GameOff", null, { width: 960, height: 540 });
