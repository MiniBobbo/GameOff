...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/data/entities.json", AssetType.TEXT);
		path.set ("assets/data/entities.png", "assets/data/entities.png");
		type.set ("assets/data/entities.png", AssetType.IMAGE);
		...
		var id;
		id = "assets/data/entities.json";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/entities.png";
		path.set (id, id);
